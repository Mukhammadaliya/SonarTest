...
directory_path = '/'.join(dirs[0: len(dirs)])
...
source_dir = '/{}'.format(sys.argv[2])

destination_dir = 'target/db_install'
...
start   = readBufferFrom('start.sql', ['start_ui.sql', 'start_uis.sql'], '')
